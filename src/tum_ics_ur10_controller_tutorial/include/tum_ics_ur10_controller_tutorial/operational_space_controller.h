  ...
  namespace RobotControllers
  {
    ...
    public:
     ...
     enum Phase
      ...
      Phase currentPhase(double t_sec,
    ...
    private:
      ...
      // ===== NEW =====
      cc::Matrix3 Kd_x_;                       // task-space derivative gains (pos-only)
      Eigen::Matrix<double, 3, 6> Jv_prev_;    // previous linear Jacobian (for Jdot*qdot approx)
      bool Jv_prev_valid_;                     // validity flag
