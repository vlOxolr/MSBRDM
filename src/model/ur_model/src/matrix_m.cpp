...
void URModel::matrix_M(cc::MatrixDof &M,
                        const cc::JointPosition &q) const
{
  ...
  cc::Scalar c2c2 = (cos(q(1))) * (cos(q(1)));
  cc::Scalar c3c3 = c3 * c3;
  cc::Scalar c4c4 = c4 * c4;
  cc::Scalar c5c5 = c5 * c5;
  cc::Scalar c3c3c2c2 = c3c3 * c2c2;
  cc::Scalar c6c6 = c6 * c6;
  cc::Scalar c2s2 = (cos(q(1))) * s2;
  cc::Scalar c3s3 = c3 * (sin(q(2)));
  cc::Scalar c5s5 = c5 * s5;
  cc::Scalar c5s5c6 = c5s5 * c6;
  cc::Scalar c5s5s6 = c5s5 * s6;
  cc::Scalar c6s6 = c6 * s6;
  cc::Scalar c3s3c2s2 = c3s3 * c2s2;
  cc::Scalar c4s5 = c4 * s5;
  cc::Scalar c6c5 = c6 * c5;
  cc::Scalar c5s6 = c5 * s6;
  cc::Scalar c6s6s5 = c6s6 * s5;
  cc::Scalar a37 = L3 * L3 * m4;
  cc::Scalar a38 = L3 * L3 * m5;
  cc::Scalar a39 = L3 * L3 * m6;
  cc::Scalar a42 = L5 * L5 * m6;
  cc::Scalar a43 = L9 * L9 * m3;
  cc::Scalar a45 = L11 * L11 * m5;
  cc::Scalar a46 = L2 * L2 * m3;
  cc::Scalar a47 = L2 * L2 * m4;
  cc::Scalar a48 = L2 * L2 * m5;
  cc::Scalar a49 = L2 * L2 * m6;
  cc::Scalar a50 = L8 * L8 * m2;
  cc::Scalar a51 = L12 * L12 * m6;
  cc::Scalar a52 = L4 * L12 * m6;
  cc::Scalar a53 = L3 * L5 * m6;
  cc::Scalar a54 = L3 * L11 * m5;
  cc::Scalar a55 = L3 * L12 * m6;
  cc::Scalar a56 = L2 * L3 * m4;
  cc::Scalar a57 = L2 * L3 * m5;
  cc::Scalar a58 = L2 * L3 * m6;
  cc::Scalar a59 = L2 * L9 * m3;
  cc::Scalar a60 = L5 * L12 * m6;
  cc::Scalar a63 = L2 * L12 * m6;
  cc::Scalar a64 = L2 * L4 * m5;
  cc::Scalar a65 = L2 * L4 * m6;
  cc::Scalar a66 = L2 * L10 * m4;
  cc::Scalar b24 = (c4 * s2 + s4 * cos(q(1))) * c3 + ((cos(q(1)) * sin(q(2))) * c4 + (-sin(q(2))) * s2 * s4);
  cc::Scalar b25 = (c3 * s4 * cos(q(1)) - s2 * s4 * sin(q(2)) + c4 * cos(q(1)) * sin(q(2)) + c3 * c4 * s2) * c5s5;
  cc::Scalar b26 = (c6 * s4 * cos(q(1)) + c4 * c6 * s2 + c5 * s2 * s4 * s6 - c4 * c5 * s6 * cos(q(1))) * c3 + ((c4 * cos(q(1)) * sin(q(2))) * c6 + (c4 * c5 * s6 * sin(q(2))) * s2 + (c5 * s6 * cos(q(1)) * sin(q(2))) * s4 + (-sin(q(2))) * c6 * s2 * s4) + 2 * ((c5c5 * s2 * s4 * sin(q(2)) - c3 * c5c5 * s4 * cos(q(1)) - c4 * c5c5 * cos(q(1)) * sin(q(2)) - c3 * c4 * c5c5 * s2) * c6);
  cc::Scalar b27 = (s2 * sin(q(2)) - c3 * cos(q(1))) * c4 + ((cos(q(1)) * sin(q(2))) * s4 + c3 * s2 * s4);
  cc::Scalar b28 = (c4 * s2 * sin(q(2)) + s4 * cos(q(1)) * sin(q(2)) + c3 * s2 * s4 - c3 * c4 * cos(q(1))) * c5;
  cc::Scalar b29 = (c3 * s4 * cos(q(1)) - s2 * s4 * sin(q(2)) + c4 * cos(q(1)) * sin(q(2)) + c3 * c4 * s2) * s5;
  cc::Scalar b30 = (c4 * s2 + s4 * cos(q(1))) * c3 + ((cos(q(1)) * sin(q(2))) * c4 + (-sin(q(2))) * s2 * s4) + 2 * ((s2 * s4 * sin(q(2)) - c3 * s4 * cos(q(1)) - c4 * cos(q(1)) * sin(q(2)) - c3 * c4 * s2) * c5c5);
  cc::Scalar b31 = c3 * cos(q(1)) - s2 * sin(q(2));
  cc::Scalar b32 = (c4 - c4 * c6c6) * c3 * c5s5 * s2 + (cos(q(1)) - c6c6 * cos(q(1))) * c3 * c5s5 * s4 + (c6s6 * s5) * c3 * s2 * s4 + (-c4 * c6s6 * s5 * cos(q(1))) * c3 + (c6c6 * sin(q(2)) - sin(q(2))) * c5s5 * s2 * s4 + (c4 * cos(q(1)) * sin(q(2)) - c4 * c6c6 * cos(q(1)) * sin(q(2))) * c5s5 + (c4 * c6s6 * s5 * sin(q(2))) * s2 + (c6s6 * s5 * cos(q(1)) * sin(q(2))) * s4;
  cc::Scalar b33 = (c3 * s2 * s4 * s5 - c3 * c4 * s5 * cos(q(1)) + c4 * s2 * s5 * sin(q(2)) + s4 * s5 * cos(q(1)) * sin(q(2))) * c6s6 + ((c6c6 * c5s5 * s2 * sin(q(2))) * s4 + (-c4 * c6c6 * c5s5 * s2) * c3 + (-c6c6 * c5s5 * cos(q(1))) * c3 * s4 - c4 * c6c6 * c5s5 * cos(q(1)) * sin(q(2)));
  cc::Scalar b34 = (s4 * s6 * sin(q(2)) - c3 * c4 * s6 + c4 * c5 * c6 * sin(q(2)) + c3 * c5 * c6 * s4) * s2 + ((c5 * c6 * cos(q(1)) * sin(q(2))) * s4 + (-c4 * c5 * c6 * cos(q(1))) * c3 + (-c4 * cos(q(1)) * sin(q(2))) * s6 + (-cos(q(1))) * c3 * s4 * s6) + 2 * ((c3 * c4 * s2 * s6 + c3 * s4 * s6 * cos(q(1)) - s2 * s4 * s6 * sin(q(2)) + c4 * s6 * cos(q(1)) * sin(q(2))) * c5c5);
  cc::Scalar b35 = cos(q(1)) * sin(q(2)) + c3 * s2;
  cc::Scalar b36 = (c3 * c4 * cos(q(1)) - s4 * cos(q(1)) * sin(q(2)) - c3 * s2 * s4 - c4 * s2 * sin(q(2))) * s5 + 2 * ((c6c6 * s2 * s5 * sin(q(2)) - c3 * c6c6 * s5 * cos(q(1)) + c5s5 * c6s6 * cos(q(1)) * sin(q(2)) + c3 * c5s5 * c6s6 * s2) * c4 + ((c6c6 * s2 * s4 * s5) * c3 + (s4 * cos(q(1))) * c3 * c5s5 * c6s6 + (-s2 * s4 * sin(q(2))) * c5s5 * c6s6 + c6c6 * s4 * s5 * cos(q(1)) * sin(q(2))));
  cc::Scalar b37 = (cos(q(1)) * sin(q(2)) + c3 * s2) * c5;
  cc::Scalar b38 = (c4 * s2 * sin(q(2)) + s4 * cos(q(1)) * sin(q(2)) + c3 * s2 * s4 - c3 * c4 * cos(q(1))) * s5;
  cc::Scalar b39 = (c3 * s4 * cos(q(1)) - s2 * s4 * sin(q(2)) + c4 * cos(q(1)) * sin(q(2)) + c3 * c4 * s2) * c5;
  cc::Scalar b40 = (c3 * c4 * s2 * s5 + c3 * s4 * s5 * cos(q(1)) - s2 * s4 * s5 * sin(q(2)) + c4 * s5 * cos(q(1)) * sin(q(2))) * c6;
  cc::Scalar b41 = (c3 * c4 * s2 * s6 + c3 * s4 * s6 * cos(q(1)) - s2 * s4 * s6 * sin(q(2)) + c4 * s6 * cos(q(1)) * sin(q(2))) * s5;
  cc::Scalar b42 = (c3 * s4 * cos(q(1)) - s2 * s4 * sin(q(2)) + c4 * cos(q(1)) * sin(q(2)) + c3 * c4 * s2) * c5 + 2 * ((c6s6 * s2 * s4 - c4 * c6s6 * cos(q(1)) - c6 * c6c5 * s4 * cos(q(1)) - c4 * c6 * c6c5 * s2) * c3 + ((cos(q(1)) * sin(q(2))) * c6s6 * s4 + (c6 * c6c5 * sin(q(2))) * s2 * s4 + (c4 * sin(q(2))) * c6s6 * s2 - c4 * c6 * c6c5 * cos(q(1)) * sin(q(2))));
  cc::Scalar b43 = (c3 * cos(q(1)) - s2 * sin(q(2))) * s5;
  cc::Scalar b44 = (c6 * c5s6) * c3 * c4 * s2 + (cos(q(1)) - c6c6 * cos(q(1))) * c3 * c4 + (c6c6 - 1) * c3 * s2 * s4 + (c6 * c5s6 * cos(q(1))) * c3 * s4 + (c6c6 * sin(q(2)) - sin(q(2))) * c4 * s2 + (c6 * c5s6 * cos(q(1)) * sin(q(2))) * c4 + (-c6 * c5s6 * sin(q(2))) * s2 * s4 + (c6c6 * cos(q(1)) * sin(q(2)) - cos(q(1)) * sin(q(2))) * s4;
  cc::Scalar b45 = (c6c6 * s2 * s4 - c4 * c6c6 * cos(q(1)) + c6 * c5s6 * s4 * cos(q(1)) + c4 * c6 * c5s6 * s2) * c3 + ((cos(q(1)) * sin(q(2))) * c6c6 * s4 + (c4 * sin(q(2))) * c6c6 * s2 + (-c6 * c5s6 * sin(q(2))) * s2 * s4 + c4 * c6 * c5s6 * cos(q(1)) * sin(q(2)));
  cc::Scalar b46 = (c4 * s6 * cos(q(1)) - s2 * s4 * s6 + c5 * c6 * s4 * cos(q(1)) + c4 * c5 * c6 * s2) * c3 + ((c5 * c6 * cos(q(1)) * sin(q(2))) * c4 + (-c5 * c6 * s4 * sin(q(2))) * s2 + (-s4 * cos(q(1)) * sin(q(2))) * s6 + (-sin(q(2))) * c4 * s2 * s6);
  cc::Scalar b47 = (c6 * s2 * s4 - c4 * c6 * cos(q(1)) + c4 * c5 * s2 * s6 + c5 * s4 * s6 * cos(q(1))) * c3 + ((cos(q(1)) * sin(q(2))) * c6 * s4 + (c4 * sin(q(2))) * c6 * s2 + (-c5 * s6 * sin(q(2))) * s2 * s4 + c4 * c5 * s6 * cos(q(1)) * sin(q(2)));
  cc::Scalar b48 = (1 - c5c5) * c6c6;
  cc::Scalar b49 = c5c5 - 1;
  cc::Scalar b50 = 2 * ((1 - c5c5) * c6s6);
  cc::Scalar b51 = (1 - c6c6) * c5c5 + (c6c6 - 1);
  cc::Scalar b54 = c3 * c4s5 - s4 * s5 * sin(q(2));
  cc::Scalar b55 = c3 * s4 + c4 * sin(q(2));
  cc::Scalar b56 = -s5 + 2 * c6c6 * s5;
  cc::Scalar b57 = (c3 * s4 + c4 * sin(q(2))) * c5;
  cc::Scalar d1 = I523 - a60;
  cc::Scalar d7 = (L5 * m6 + L11 * m5) * L2;
  cc::Scalar d9 = I511 - I522 - I633 + a51;
  cc::Scalar d10 = (L5 * m6 + L11 * m5) * L4 + I423;
  cc::Scalar d11 = (m5 + m6) * L3 * L4 + (L10 * m4) * L3 - I313;
  cc::Scalar d12 = I533 + a51;
  cc::Scalar d13 = I511 + a51;
