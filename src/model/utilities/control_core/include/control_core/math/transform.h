...
#ifndef CONTROL_CORE_MATH_TRANSFORM_H
#define CONTROL_CORE_MATH_TRANSFORM_H
...
inline Vector3 changeRefFrame(
    const control_core::Vector3Base<Derived>& v_child,
    const HomogeneousTransformation& T_parent_child)
{
  return T_parent_child.orientation()*v_child.derived();
}
...
inline AngularAcceleration changeRefFrame(
    const control_core::AngularAccelerationBase<Derived>& xPP_child,
    const HomogeneousTransformation& T_parent_child)
{
  return T_parent_child.orientation()*xPP_child.derived();
}
...
inline AngularPosition changeRefFrame(
    const control_core::AngularPositionBase<Derived>& Q_child,
    const HomogeneousTransformation& T_parent_child)
{
...
inline AngularVelocity changeRefFrame(
    const control_core::AngularVelocityBase<Derived>& xP_child,
    const HomogeneousTransformation& T_parent_child)
{
  return T_parent_child.orientation()*xP_child.derived();
}
...
inline Force changeRefFrame(
    const control_core::ForceBase<Derived>& f_child,
    const HomogeneousTransformation& T_parent_child)
{
  return T_parent_child.orientation()*f_child.derived();
}
...
inline LinearAcceleration changeRefFrame(
    const control_core::LinearAccelerationBase<Derived>& xPP_child,
    const HomogeneousTransformation& T_parent_child)
{
  return T_parent_child.orientation()*xPP_child.derived();
}
...
inline LinearPosition changeRefFrame(
    const control_core::LinearPositionBase<Derived>& x_child,
    const HomogeneousTransformation& T_parent_child)
{
...
inline LinearVelocity changeRefFrame(
    const control_core::LinearVelocityBase<Derived>& xP_child,
    const HomogeneousTransformation& T_parent_child)
{
  return T_parent_child.orientation()*xP_child.derived();
}
...
inline Moment changeRefFrame(
    const control_core::MomentBase<Derived>& mu_child,
    const HomogeneousTransformation& T_parent_child)
{
  return T_parent_child.orientation()*mu_child.derived();
}
...
inline Derived changeRefFrame(
    const control_core::CartesianBase<Derived>& X_child,
    const HomogeneousTransformation& T_parent_child)
{
  Derived X_new;
...
template <typename Derived>
inline Derived changeRefFrame(
  const control_core::StateBase<Derived>& X_child,
  const HomogeneousTransformation& T_parent_child)
{
  Derived X_new;
...
#endif // CONTROL_CORE_MATH_TRANSFORM_LINEAR_ACCELERATION_H
