...
#ifndef CONTROL_CORE_FORWARD_DECLARATIONS_H
#define CONTROL_CORE_FORWARD_DECLARATIONS_H


/*! \file forward_declarations.h
 * \brief Contains all the forward declarations needed in the control_core package.
 */
...
#endif // CONTROL_CORE_FORWARD_DECLARATIONS_H
