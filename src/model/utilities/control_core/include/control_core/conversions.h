...
#ifndef CONTROL_CORE_CONVERSIONS_H
#define CONTROL_CORE_CONVERSIONS_H
...
/*!
 *  \brief Converts an Eigen::EigenBase to a control_core_msgs::Vector.
 */
template <typename _Derived>
void eigenToVectorMsg(const Eigen::MatrixBase<_Derived>& e, control_core_msgs::Vector& t)
{
  typedef Eigen::Matrix<double, _Derived::ColsAtCompileTime, _Derived::RowsAtCompileTime> Base;
  Base ed = e.template cast<double>();
 ...
 */
template <typename _Derived>
void vectorMsgToEigen(const control_core_msgs::Vector& t, Eigen::MatrixBase<_Derived>& e)
{
  typedef typename Eigen::MatrixBase<_Derived>::Scalar Scalar;
  Eigen::VectorXd ed;
...
#endif  // CONTROL_CORE_CONVERSIONS_H
