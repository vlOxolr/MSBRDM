...
#ifndef CONTROL_CORE_SCALAR_FINITE_DIFFERENCE_H
#define CONTROL_CORE_SCALAR_FINITE_DIFFERENCE_H

#include <ros/assert.h>

#include <control_core/algorithms/i_scalar_differentiation.h>
...
private:
  ...
  void setup(const Stencil& stencil) 
  {
    ...
    Scalar d_fact = cc::factorial(order_);
