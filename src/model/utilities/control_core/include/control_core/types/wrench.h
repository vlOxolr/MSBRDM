...
#ifndef CONTROL_CORE_WRENCH_H
#define CONTROL_CORE_WRENCH_H

#include <geometry_msgs/Wrench.h>

#include <control_core/type_references/force_ref.h>
#include <control_core/type_references/moment_ref.h>
...
struct traits<control_core::Wrench<_Scalar> >
{
  typedef Eigen::Matrix<_Scalar, 6, 1> Base;
  typedef control_core::ForceRef<Base> LinearRef;
  typedef control_core::MomentRef<Base> AngularRef;
  typedef control_core::ForceRef<const Base> CLinearRef;
  typedef control_core::MomentRef<const Base> CAngularRef;
  enum {
