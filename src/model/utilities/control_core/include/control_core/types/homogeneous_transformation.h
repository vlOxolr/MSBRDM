...
#ifndef CONTROL_CORE_HOMOGENEOUS_TRANSFORMATION_H
#define CONTROL_CORE_HOMOGENEOUS_TRANSFORMATION_H

#include <control_core/utilities/type_guard.h>
#include <control_core/type_references/rotation3_ref.h>
...
#endif  // CONTROL_CORE_HOMOGENEOUS_TRANSFORMATION_H
