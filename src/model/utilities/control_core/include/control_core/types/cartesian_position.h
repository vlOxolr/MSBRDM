...
#ifndef CONTROL_CORE_CARTESIAN_POSITION_REF_H
#define CONTROL_CORE_CARTESIAN_POSITION_REF_H

#include <control_core/utilities/type_guard.h>
#include <control_core/type_references/angular_position_ref.h>
#include <control_core/type_references/linear_position_ref.h>
...
struct traits<control_core::CartesianPosition<_Scalar> >
{
  typedef Eigen::Matrix<_Scalar, 7, 1> Base;
  typedef control_core::LinearPositionRef<Base> LinearRef;
  typedef control_core::AngularPositionRef<Base> AngularRef;
  typedef control_core::LinearPositionRef<const Base> CLinearRef;
  typedef control_core::AngularPositionRef<const Base> CAngularRef;
  enum {
...
public:
  ...
  /*!
   * \brief Assignment from cc::HomogenousTransformation.
   */
   ...
   */
  template <typename OtherDerived>
  control_core::Vector3<Scalar> operator*(const control_core::Vector3Base<OtherDerived>& other) const
  {
...
#endif  // CONTROL_CORE_CARTESIAN_POSITION_REF_H
