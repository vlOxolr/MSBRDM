...
#ifndef CONTROL_CORE_ROTATION3_H
#define CONTROL_CORE_ROTATION3_H
...
public:
   ...
   *  Returns a Rotation Matrix constructed from roll pitch and yaw euler angles
   */
  static Rotation3 RPY(const control_core::Vector3<Scalar>& rpy =
      control_core::Vector3<Scalar>::Zero())
  {
  ...
  *   cc::Rotation3 R = cc::Rotation3::Random(rd)
  */
  template<typename Generator>
  static Rotation3 Random(Generator& generator)
  {
    return cc::uniformRandomRotation<Scalar>(generator);
  }
...
public:
   ...
   */
  explicit Rotation3(const control_core::AngularPosition<Scalar>& other) :
    Base(other)
  {
  }
   ...
   */
  template <typename OtherDerived>
  explicit Rotation3(const control_core::AngularPositionRef<OtherDerived>& other) :
    Base(other)
  {
  }
  ...
  Rotation3& operator=(const control_core::AngularPosition<Scalar>& other)
  {
    Base::operator=(other);
    return *this;
  }
  ...
  template <typename OtherDerived>
  Rotation3& operator=(const control_core::AngularPositionRef<OtherDerived>& other)
  {
    Base::operator=(other);
    return *this;
  }
...
#endif  // CONTROL_CORE_ROTATION3_H
